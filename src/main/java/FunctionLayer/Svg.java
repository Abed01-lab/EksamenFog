...
public class Svg {
    ...
    private final String krydsTemplate = "<line x=\"%d\" y =\"%d\" x1=\"%d\" y1=\"%d\" style=\"stroke:#000000; stroke-dasharray: 10 5\" </line>";
    ...
    public void addKryds(int x, int y, int x1, int y1){
